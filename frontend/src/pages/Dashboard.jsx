...
const Dashboard = () => {
  ...
  // New Form State matching Backend Requirements
  ...
  // 2. Handle "Add Task" (Send to Gemini)
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input 
                                ...
                                className="col-span-3" 
                                placeholder="Number of problems/pages"
                            />
                        </div>

                        {/* Complexity Dropdown (Native Select for simplicity) */}
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            >
                                ...
                                <option value="Hard">Hard (Exam Prep/Project)</option>
                            </select>
                        </div>
                        ...
                        <div className="grid grid-cols-4 items-start gap-4">
                            ...
                            <Textarea 
                                ...
                                className="col-span-3" 
                                placeholder="Paste assignment details here so AI can break it down..."
                            />
                        </div>
                    </div>
