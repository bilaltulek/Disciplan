...
const buttonVariants = cva(
  ...
  {
    variants: {
      variant: { default: 'glass-accent hover:brightness-110', destructive: 'bg-destructive text-destructive-foreground shadow-[0_14px_28px_-14px_rgba(220,38,38,0.8)] hover:bg-destructive/90', outline: 'glass-chip text-foreground hover:bg-white/65', secondary: 'bg-secondary/75 text-secondary-foreground backdrop-blur-md hover:bg-secondary', ghost: 'text-muted-foreground hover:bg-white/50 hover:text-foreground', link: 'text-primary underline-offset-4 hover:underline' },
