...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "glass-accent hover:brightness-110",
        destructive: "bg-destructive text-destructive-foreground shadow-[0_14px_28px_-14px_rgba(220,38,38,0.8)] hover:bg-destructive/90",
        outline: "glass-chip text-foreground hover:bg-white/65",
        secondary: "bg-secondary/75 text-secondary-foreground backdrop-blur-md hover:bg-secondary",
