...
app.patch('/api/planning-profile', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.post('/api/register', validateRegister, authRateLimit, withErrorBoundary(async (req, res) => {
...
app.post('/api/login', validateLogin, authRateLimit, withErrorBoundary(async (req, res) => {
...
app.post('/api/assignments', authenticateToken, agentRateLimit, validateAssignment, withErrorBoundary(async (req, res) => {
  const {
...
app.get('/api/runtime-capabilities', authenticateToken, (req, res) => {
  return res.json(agentCapabilitiesForRequest(config, req));
});

app.patch('/api/profile', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.get('/api/agent-runs/:id', authenticateToken, withErrorBoundary(async (req, res) => {
  const run = await getRunForUser(req.params.id, req.user.id);
  if (!run) return res.status(404).json({ error: 'Planning run not found.' });
  return res.json({ run });
}));

app.post('/api/agent-threads', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.get('/api/agent-threads', authenticateToken, withErrorBoundary(async (req, res) => {
...
app.get('/api/agent-threads/:id', authenticateToken, withErrorBoundary(async (req, res) => {
...
app.post('/api/agent-threads/:id/messages', authenticateToken, agentRateLimit, requireActiveAgentRuntime, withErrorBoundary(async (req, res) => {
...
app.get('/api/approvals', authenticateToken, withErrorBoundary(async (req, res) => {
...
app.get('/api/approvals/:id', authenticateToken, withErrorBoundary(async (req, res) => {
  const approval = await getApprovalForUser({ userId: req.user.id, approvalId: req.params.id });
  if (!approval) return res.status(404).json({ error: 'Approval not found.' });
  return res.json(approval);
}));

app.post('/api/approvals/:id/decision', authenticateToken, agentRateLimit, requireActiveAgentRuntime, withErrorBoundary(async (req, res) => {
...
app.get('/api/preference-memories', authenticateToken, withErrorBoundary(async (req, res) => {
...
app.post('/api/preference-memories/:id/confirm', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.delete('/api/preference-memories/:id', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.get('/api/agent-runs/:id/events', authenticateToken, withErrorBoundary(async (req, res) => {
...
app.post('/api/agent-runs/:id/cancel', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
...
app.post('/api/agent-runs/:id/retry', authenticateToken, agentRateLimit, requireActiveAgentRuntime, withErrorBoundary(async (req, res) => {
...
app.post('/api/assignments/:id/tasks', authenticateToken, agentRateLimit, validateIdParam, withErrorBoundary(async (req, res) => {
...
app.post('/api/assignments/:id/feedback', authenticateToken, agentRateLimit, validateIdParam, withErrorBoundary(async (req, res) => {
...
app.delete('/api/account', authenticateToken, agentRateLimit, withErrorBoundary(async (req, res) => {
