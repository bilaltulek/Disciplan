...
try {
  ...
  const environment = {
    ...
    GEMINI_ROUTER_MODEL: local.GEMINI_ROUTER_MODEL || 'gemini-3.5-flash-lite',
    GEMINI_AGENT_MODEL: local.GEMINI_AGENT_MODEL || 'gemini-3.6-flash',
    GEMINI_SEARCH_MODEL: local.GEMINI_SEARCH_MODEL || 'gemini-3.6-flash',
    ...
    AI_AGENT_MAX_SEARCH_CALLS: local.AI_AGENT_MAX_SEARCH_CALLS || '2',
    AI_SEARCH_MONTHLY_REQUEST_LIMIT: local.AI_SEARCH_MONTHLY_REQUEST_LIMIT || '100',
